 ...
 */
public class ItemProductsAdapter extends ArrayAdapter<ItemCart> {

    private int resource;
    private CallBackItemClick callBackItemClick;
    private App app;

    public ItemProductsAdapter(Context context, int resource, List<ItemCart> objects) {
        super(context, resource, objects);
    }

    public ItemProductsAdapter(Context context, int resource, List<ItemCart> objects, CallBackItemClick callBackItemClick) {
        super(context, resource, objects);
